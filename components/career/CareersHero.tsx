...
import { ChevronRight, BriefcaseBusiness, ArrowDown } from "lucide-react";
  ...
  return (
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/images/careers/careers-hero.jpg')",
        }}
      />
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 text-center lg:px-12">
        ...
        >
          <BriefcaseBusiness className="h-10 w-10 text-[#C9A14A]" />
        </motion.div>
        ...
        >
          <Link href="/" className="transition hover:text-[#C9A14A]">
            Home
          </Link>

          <ChevronRight size={16} />

          <span className="text-[#C9A14A]">Careers</span>
        </motion.div>
        ...
        >
          Join Manjeet Pride Group and become part of a passionate team
          shaping exceptional residential, commercial, and township
          developments. Together, let's build inspiring spaces and
          successful careers.
        </motion.p>
        ...
        >
          ...
          <div className="rounded-2xl border border-white/10 bg-white/10 p-6 backdrop-blur-md">
            <h3 className="text-3xl font-bold text-[#C9A14A]">900+</h3>
            <p className="mt-2 text-gray-300">Happy Families</p>
          </div>
        </motion.div>
      </div>
