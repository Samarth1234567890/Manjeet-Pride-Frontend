...
export default function ContactHero() {
  return (
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden">
      ...
      {/* Glow Effects */}
      <div className="absolute -left-32 top-20 h-96 w-96 rounded-full bg-[#0B5FA5]/30 blur-3xl" />

      <div className="absolute -right-32 bottom-20 h-96 w-96 rounded-full bg-[#C9A14A]/20 blur-3xl" />
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6 text-center">
        ...
        >
          Have questions about our projects or want to schedule a meeting?
          Our team at Manjeet Pride Group is here to assist you with every
          step towards finding your perfect space.
        </motion.p>
